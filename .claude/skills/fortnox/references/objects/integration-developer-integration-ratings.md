# Fortnox Object: Integration Ratings

API group `integration-developer` · spec tag `integration-developer_Integration Ratings`
...
| Method | Path | Summary |
|---|---|---|
| GET | `/api/integration-developer/ratings-v1` | List rating and reviews for integrations that you own |
...
```python
result = client.get("https://api.fortnox.se/api/integration-developer/ratings-v1")
```
...
`comment`, `companyEmployeeRange`, `companyName`, `created`, `integrationId`, `isMyRating`, `rating`, `ratingId`, `response`, `updated`

## Resource filters

| Parameter | Values | Notes |
|---|---|---|
| `includeOnlyUnrespondedRatings` | boolean |  |
...
- Read Integration Ratings for investigation, reporting and export.
